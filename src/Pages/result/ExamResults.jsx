      ...
      <div className=" flex max-lg:block bg-background h-screen overflow-hidden">
       ...
       <div className=" py-5 pr-5 pl-3 w-full">
          ...
          <div className=" flex justify-between  w-full mb-5">
            ...
            <div className="  w-[28%] h-[48px] rounded-10 bg-[#D4DAEE] flex justify-center items-center">
              ...
              <div className=" flex w-full justify-center">
                ...
                <p className=" text-[16px] text-[#364786] font-semibold my-auto">Exam Results</p>
           ...
           <div className=' flex justify-center items-center w-[70%] my-auto  relative'>
            ...
            <input type='search' className=' w-full h-[48px] rounded-10 border border-[#8599DD] pl-[16px] py-[8px] pr-[70px]' placeholder='Search Exam' />
          ...
          <div className=" w-full h-[90.5%] bg-white py-7 px-[30px]  rounded-10 ">
            ...
            <div className=" grid grid-cols-9 text-center pr-2 ">
                ...
                <div className="  text-[16px] font-semibold text-[#0A112C] h-[96px] flex justify-center">
                  ...
                  <div className=" my-auto w-full">
                    ...
                    <p>Project</p>
                    <p className=" text-[14px] font-medium  mx-auto font-poppins  rounded-[6px] text-[#435596] mt-4 h-[32px] w-[45px] bg-[#F6F6F6] border border-[#99A1DA] flex justify-center items-center "><span>20</span></p>
                ...
                <div className="  text-[16px] font-semibold text-[#0A112C] h-[96px] flex justify-center">
                  ...
                  <div className=" my-auto w-full">
                    ...
                    <p>Online Exam</p>
                    <p className=" text-[14px] font-medium  mx-auto font-poppins  rounded-[6px] text-[#435596] mt-4 h-[32px] w-[45px] bg-[#F6F6F6] border border-[#99A1DA] flex justify-center items-center "><span>0</span></p>
                ...
                <div className="  text-[16px] font-semibold text-[#0A112C] h-[96px] flex justify-center">
                  ...
                  <div className=" my-auto w-full">
                    ...
                    <p> Exam</p>
                    <p className=" text-[14px] font-medium  mx-auto font-poppins  rounded-[6px] text-[#435596] mt-4 h-[32px] w-[45px] bg-[#F6F6F6] border border-[#99A1DA] flex justify-center items-center "><span>40</span></p>
                ...
                <div className=" overflow-auto col-span-9 grid grid-cols-9 h-[62vh] pr-3 -mr-[1.3vw] ">
                      {ResultsExamsData.map((RXD , id) => (<>
                        ...
                        <div className={`${id%2===0&& 'bg-[#E9ECF8]'} h-[52px] w-full flex justify-center items-center `}>
                          ...
                          <p className="  text-[14px] font-[500]  text-[#000000]">{RXD.tts}</p>

                        </div>

                        <div className={`${id%2===0&& 'bg-[#E9ECF8]'} h-[52px] w-full flex justify-center items-center `}>

                          <p className=" text-[14px] font-medium  mx-auto font-poppins  rounded-[6px] text-[#435596]  h-[32px] w-[45px] bg-[#F6F6F6] border border-[#99A1DA] flex justify-center items-center "><span>{RXD.project}</span></p>

                        </div>

                        <div className={`${id%2===0&& 'bg-[#E9ECF8]'} h-[52px] w-full flex justify-center items-center `}>

                          <p className=" text-[14px] font-medium  mx-auto font-poppins  rounded-[6px] text-[#435596]  h-[32px] w-[45px] bg-[#F6F6F6] border border-[#99A1DA] flex justify-center items-center "><span>{RXD.onlineExam}</span></p>
                        ...
                        <div className={`${id%2===0&& 'bg-[#E9ECF8]'} h-[52px] w-full flex justify-center items-center `}>
                          ...
                          <p className=" text-[14px] font-medium  mx-auto font-poppins  rounded-[6px] text-[#435596]  h-[32px] w-[45px] bg-[#F6F6F6] border border-[#99A1DA] flex justify-center items-center "><span>{RXD.exam}</span></p>
